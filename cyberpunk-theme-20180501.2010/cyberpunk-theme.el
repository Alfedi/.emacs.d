...
;;			   ))))
 ...
 ;; Cool Cherry-blossom statusline
   '(mode-line
   ((((class color) (min-colors 88)) (:background "#222222" :foreground "#4c83ff"))
 ...
 ;; End Cherry-blossom cool powerline
   ...
   `(vertical-border ((,class (:foreground "#000000" :background "#000000"))))
